...
import { curdapi_offlane } from '../CRUD/crudapi_offlane';

@Component({
  selector: 'app-offlane',
  templateUrl: './offlane.page.html',
  styleUrls: ['./offlane.page.scss'],
})
export class OfflanePage implements OnInit {
  r3: any;
  constructor(private getcrud:curdapi_offlane) {}
  ngOnInit(){
